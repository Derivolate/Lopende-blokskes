...
namespace Assets.Scripts
{
    ...
    public class Camera_controller : MonoBehaviour
    {
        ...
        [Range(0, 1.0F)]
        public float move_speed_scrollwheel;
        [Range(0, 10.0F)]
        public float move_speed_cursor;
        [Range(0, 1.0F)]
        ...
        private void move_camera()
        {
            ...
            if (Input.GetMouseButton(2))
            {
                ...
                else
                {
                    ...
                    this.gameObject.transform.position += transform.right * diff.x * move_speed_scrollwheel * .2f;
                    gameObject.transform.position += Quaternion.AngleAxis(-90f, Vector3.up) * transform.right * diff.y * move_speed_scrollwheel * .2f;
                    old_mouse_pos = Input.mousePosition;
                }
            }
            else
            {
                ...
                rigidbody.velocity = direction * move_speed_cursor;
            }
        }
        /// <summary>
